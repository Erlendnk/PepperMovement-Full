...
""""Live images from Nao using PyQt"""
...
class ImageWidget(QWidget):
    ...
    def __init__(self, video_service, CameraID, parent=None):
        ...
        # Trigger 'timerEvent' every 100 ms.
        # self.startTimer(100)
        self.startTimer(100)
    ...
    def _updateImage(self):
        """ Retrieve a new image from Pepper. """
    ...
    def timerEvent(self, event):
        """ Called periodically. Retrieve image and update """

        self._updateImage()
        self.update()

    def __del__(self):
        """ When the widget is deleted, unregister naoqi video module. """
